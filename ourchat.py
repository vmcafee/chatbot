...
pairs = (
    ...
    (r"wolfram:answer:(.*)",
     ( "Good question!! the answer is, %1",
      ...
      "Why do you ask? ok will still tell you %1")
     ),
    (r"wolfram:noanswer:(.*)",
     ( "hmmm... I don't know about that!",
      "hmmm.. difficult to answer",
      "I will find out and let you know later!")
     ),
    (r"organization:(.*)",
    ...
    (r"oldtopic:(.*)",
     ( "ok, Let's talk more about %1",
       "hmm.. ok, I remember you mentioning %1 before, tell me more.")
     ),
    (r'I\'m (.*)',
    ( "ur%1? that's great! tell me more!",
      "ur%1? neat!! hehehe >_<")),
    (r'(.*) don\'t you (.*)',
    ( "u think I can%2??! really??",
      "what do u mean%2??!",
      "i could if i wanted, don't you think!! ")),
    (r'ye[as] [iI] (.*)',
    ( "u%1? cool!! how?",
      "how come u%1??",
      "u%1? so do i!!")),
    (r'do (you|u) (.*)\??',
    ( "do i%2? only on tuesdays! kidding! *_*",
      "i dunno! do u%2??")),
    (r'(cos|because) (.*)',
    ...
    (r'I can\'t (.*)',
    ( "u can't what??! >_<",
      "that's ok! i can't%1 either! hahaha ^_^",
    ...
    ( "bye!! type quit to exit!",
      "awww u have to go?? see u next time!! type quit to exit!",
      "how to see u again soon! ^_^ , btw type quit to exit!")),
    (r'(.*)bye(.*)',
    ( "bye!! type quit to exit!",
      "awww u have to go?? see u next time!! type quit to exit!",
      "how to see u again soon! ^_^ ,  btw type quit to exit!")),
